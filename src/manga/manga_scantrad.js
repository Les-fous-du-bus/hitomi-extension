/**
 * Manga-Scantrad — Extension Hitomi Reader
 * Source : https://manga-scantrad.io
...
var BASE_URL = "https://manga-scantrad.io";
...
class DefaultExtension extends MProvider {
  ...
  _parseMadaraDate(dateText) {
    try {
      ...
      // Short French month format: "1 jan 2024" or "1 janv. 2024"
      var frMonths = {
        "jan": 0, "fev": 1, "mar": 2, "avr": 3,
        "mai": 4, "juin": 5, "juil": 6, "aou": 7,
        "sep": 8, "oct": 9, "nov": 10, "dec": 11,
        "janvier": 0, "fevrier": 1, "mars": 2, "avril": 3,
        "juillet": 6, "aout": 7, "septembre": 8, "octobre": 9,
        "novembre": 10, "decembre": 11
      };
      var frMatch = dateText.match(/(\d+)\s+(\w+)\.?\s+(\d{4})/);
      if (frMatch) {
        var key = frMatch[2].replace(/\.$/, "");
        var month = frMonths[key];
        if (month !== undefined) {
